...
import type { EditorMode, ResumeLoadResult } from './sync-service'
...
import { clearSyncTimers, getCloudAppearanceSource } from './sync-service'
import { hasPersistedAppearance, mapSnapshotToState, mapSourceToPersistedSnapshot, mergeSnapshotAppearance } from './utils'
